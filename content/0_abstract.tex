...
Finally, the automated emulation of both projects will be integrated into the test infrastructure, so that these projects are enabled for the s390x architecture of IBM Z mainframes. Overall, this method should be reusable for further open-source projects in the future.
