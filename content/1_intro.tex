...
Mainframes are called as high-performance computers that process billions of simple calculations and transactions in real-time. Some of these computers are part of the Z series\footnote{\url{https://www.ibm.com/it-infrastructure/z/hardware/}} by IBM. They are not only used as internet servers, but also for mission-critical apps and blockchain. 
...
The profit of containers is that every service can interact isolated in a separate container independent of the development environment. That simplifies the management and deployment of new software versions for paticular components.
