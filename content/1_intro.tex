...
The IBM Z system allows to run different operating systems at the same time with the support of LPARS.
A LPAR is a logical partition to separate the mainframe for different operating systems with their applications. \\
