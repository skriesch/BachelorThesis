...
It makes the VM really slow because so much will be virtualized. It is posible to reduce the supported and attached vm hardware with special options. \\
...
That is a processor emulator using binary translation\cite{Butt2011}. That will be done with the "Tiny Code Generator" (TCG) inside of QEMU. 
