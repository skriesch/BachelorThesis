...
The kernel module binfmt\_misc can be mounted with the following command: \begin{lstlisting}[style=BashInputStyle]
...
s390x binaries have to be registered for s390x. That is done with the following commands: \textbf{sudo -i} and \begin{lstlisting}[style=BashInputStyle]
