...
s390x binaries have to be registered for s390x that they can be executable on x86, as described in ref{Binfmt} "Binfmt\_misc". That is executed with the following command: \lstinline!sudo -i! and 
\begin{figure}[H]
\centering
\begin{boxedverbatim}
