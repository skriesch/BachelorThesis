...
This command "debootstrap" is validating all downloaded packages for additional security. This process is easy to automate and requires only 10 seconds. In conclusion, the generic and signed Linux kernel image can be used in the \path{/boot/} directory for the integration into \gls{QEMU}.
