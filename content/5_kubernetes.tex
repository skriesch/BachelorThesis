...
The Kubernetes project has been using Prow as a CI/CD system. Prow is a Kubernetes based CI/CD system further developed based on Jenkins. That implifies, that the existing CI/CD pipeline can work only with containers.
